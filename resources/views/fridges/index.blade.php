                            ...
                            <!-- blue line -->
                                ...
                                <div class="flex flex-col space-y-2">
                                    ...
                                    <form action="{{ route('products.create', $fridge) }}" method="post">
                                        @csrf
                                        @method('get')
                                        <button type="submit" class="flex items-center space-x-2 btn-blue bg-blue-800 hover:bg-blue-900 w-auto">
                                    ...
                                    <form action="{{ route('products.index', $fridge) }}" method="post">
                                        @csrf
                                        @method('get')
                                        <button type="submit" class="flex items-center space-x-2 btn-blue w-auto">
                                            <svg class="w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
